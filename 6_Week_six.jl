...
#   USER DEFINED  -  Simulation parameters
    ...
    # Initial parameters
    Blastwave_center = SVector(2, 2)        # center of the blast wave
    ...
    ActiveMesh = "Mesh_NO2_ThinSquares.inp"       # name of the mesh file to be used for the simulation. This file should contain the geometric and topological information about the computational domain, including the coordinates of the vertices, the connectivity of the cells, and the definition of boundary curves. The mesh file is essential for setting up the spatial discretization of the problem and ensuring that the solver can accurately represent the geometry of the domain.
#####  WHEN CHANGING MESH ALSO CHANGE THE BOUNDARY CONDITIONS TO MATCH THE CURVE NAMES IN THE MESH FILE. ##### 
    ...
    tspan_end = 5                           # end time of the simulation in sim time units
    ...
    numberofgraphs = 3                      # number of graphs to be plotted during the simulation
...
#   Mesh setup
  ...
  mesh_file = joinpath("Mesh_Files", "Meshes_Folder/", ActiveMesh)  # this line constructs the file path to the mesh file by joining the directory "Mesh_Files/Meshes_Folder/" with the mesh file name specified in the Mesh variable. This path will be used to load the mesh for the simulation.
